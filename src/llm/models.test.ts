...
describe('listModels', () => {
  ...
  it('returns fixed codex-cli models', async () => {
    await expect(listModels('codex-cli')).resolves.toEqual(['gpt-5.4-mini']);
  });

  it('returns fixed gemini-cli models', async () => {
    await expect(listModels('gemini-cli')).resolves.toEqual([
